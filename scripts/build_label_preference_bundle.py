        ...
        sections.append(
            "\n".join(
                [
                    ...
                    f'<label><input type="radio" name="{confidence_name}" value="1"> 1</label>',
                    f'<label><input type="radio" name="{confidence_name}" value="2"> 2</label>',
                    f'<label><input type="radio" name="{confidence_name}" value="3"> 3</label>',
                    "</div>",
