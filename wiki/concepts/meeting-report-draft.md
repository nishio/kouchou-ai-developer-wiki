...
- 残 issue の優先順を live state で組み直した。`#741` は 2026-05-28 に close 済み、`#866`〜`#868` も merge 済みなので、次は新規 feature より `#883 -> #876` と `#863 -> #731` の進行中 PR 着地、`#877` Windows guide 境界、`#881` / `#882` / `#869` ラベル品質実験、`#871` Blob health check、`#872` / `#493` viewer UX の順が妥当。[[remaining-issue-priority-2026-05-29]]より
...
- 2026-05-29: live open issues / PR を再確認し、`#873` merge / `#741` close 後の残件優先順を、進行中 PR 着地、Windows guide 境界、ラベル品質実験、Blob health check、viewer UX の順に整理
