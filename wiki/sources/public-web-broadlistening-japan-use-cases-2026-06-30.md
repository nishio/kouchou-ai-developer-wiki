...
| 舞鶴2040 | public viewer + FAQ | `#みんなでつくる舞鶴2040` のレポート一覧 public viewer があり、FAQ で広聴AIは DD2030 の OSS 成果物と説明されている。[[public-web-broadlistening-japan-use-cases-2026-06-30]]より | 8/2 の viewer demo 候補に追加できる。実施主体・許諾・政治文脈は別途確認。 |
