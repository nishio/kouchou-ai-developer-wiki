...
1. **Windows 初回導入を通す**  
   `#731` とその周辺 (`#666`, `#530`, `#496`) は、新規利用者が最初に離脱する箇所であり、いま最も直接的な価値がある。`PR #863` が open なので、まずはここを着地させる。[[windows-distribution-options]]より [[local-dev-setup]]より
