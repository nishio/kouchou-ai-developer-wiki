...
2. **#877 の Windows guide outline を Wiki に下書きする**: issue / docs 本体に書く前に、supported / unsupported path の表と troubleshoot 範囲を Wiki 側で固める。
3. **#876 の developer quickstart 草案を最新方針へ再点検する**: Hosted demo / Azure 体験環境、読者像 5 分岐、Mode 1 default 廃止、CLI データ量前提が草案に入っているか確認する。
